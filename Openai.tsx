...
export default function ReceitasScreen({ setCurrentScreen }: ReceitasScreenProps) {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira uma receita detalhada para o ${ocasiao} usando os ingredientes: ${ingr1}, ${ingr2}, ${ingr3} e ${ingr4} e pesquise a receita no YouTube. Caso encontre, informe o link. Por favor, comece a resposta com o título da receita no formato "TÍTULO DA RECEITA: [nome da receita]"`;
    ...
    try {
      ...
      const tituloMatch = respostaCompleta.match(/TÍTULO DA RECEITA: (.*?)(\n|$)/i);
